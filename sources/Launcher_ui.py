...
#
# Created: Mon Feb 24 20:38:13 2014
...
""))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/video.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/chromium.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonInternet.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/usb.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonUSB_2.setIcon(icon2)
        ...
        self.buttonUSB_1.setIcon(icon2)
        ...
        self.buttonPower = QtGui.QPushButton(Launcher)
        self.buttonPower.setMinimumSize(QtCore.QSize(128, 128))
        self.buttonPower.setMaximumSize(QtCore.QSize(128, 128))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/power.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonPower.setIcon(icon3)
        self.buttonPower.setIconSize(QtCore.QSize(96, 96))
        self.buttonPower.setObjectName(_fromUtf8("buttonPower"))
        self.gridLayout_12.addWidget(self.buttonPower, 0, 1, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/libreoffice.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonOffice.setIcon(icon4)
        self.buttonOffice.setIconSize(QtCore.QSize(96, 96))
        self.buttonOffice.setObjectName(_fromUtf8("buttonOffice"))
        self.gridLayout_11.addWidget(self.buttonOffice, 0, 1, 1, 1)
        ...
        self.buttonUSB_3.setIcon(icon2)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/skype.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonSkype.setIcon(icon5)
        ...
        self.buttonLoteli = QtGui.QPushButton(Launcher)
        self.buttonLoteli.setMinimumSize(QtCore.QSize(128, 128))
        self.buttonLoteli.setMaximumSize(QtCore.QSize(128, 128))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/hotel.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonLoteli.setIcon(icon6)
        self.buttonLoteli.setIconSize(QtCore.QSize(96, 96))
        self.buttonLoteli.setObjectName(_fromUtf8("buttonLoteli"))
        self.gridLayout_7.addWidget(self.buttonLoteli, 0, 1, 1, 1)
    ...
    def retranslateUi(self, Launcher):
        ...
        self.label_10.setText(_translate("Launcher", "Eteindre", None))
        self.label_3.setText(_translate("Launcher", "Musique", None))
        self.label_9.setText(_translate("Launcher", "Office", None))
        self.label_8.setText(_translate("Launcher", "USB", None))
        self.label_2.setText(_translate("Launcher", "Skype", None))
        self.label_6.setText(_translate("Launcher", "Loteli", None))
